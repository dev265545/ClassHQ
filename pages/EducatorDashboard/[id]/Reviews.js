    ...
    <div>
      <main className="bg-gray-50 min-h-screen flex max-w-[1500px] mx-auto">
        ...
        <div className="flex-grow px-3 w-full sm:ml-[73px] md:ml-[250px] xl:ml-[250px]">
          <div className="text-3xl pt-6 pb-4    border-b text-gray-800 font-normal ">
            {greeting}{" "}
            <p className="  text-pink-500  brightness-100 font-bold inline-block">
              {session?.user?.name}
            </p>
            <p className="py-1 text-xl text-gray-600">
              Lets see what people are saying about you...
            </p>
